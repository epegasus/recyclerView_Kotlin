...
class CustomAdapterMain(
    ...
    override fun onBindViewHolder(holderMain: CustomViewHolderMain, position: Int) {
        val student = studentList[position]
        with(student) {
            holderMain.tvName.text = username
            holderMain.tvRollNo.text = rollNo.toString()
        }
    }
